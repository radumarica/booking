...
>(
  (
    ...
    const wrapperClasses = [
      formClasses['form__element'],
      inputClasses['input'],
      inputClasses['input--simple'],
    ];
    if (validity === false && isTouched)
      wrapperClasses.push(inputClasses['invalid']);
      ...
      <div className={wrapperClasses.join(' ')}>
        ...
        <div className={formClasses['form__info']}>
          <div className={formClasses['form__info__content']}>
            ...
            {additionalAttrs['disabled'] === true && (
              <p className={formClasses['form__info__warning-text']}>
                {disabledMessage}
              </p>
            )}
          </div>
 ...
 */
function areEqual(
  prevProps: TypeTextFieldProps,
  nextProps: TypeTextFieldProps
) {
  const compareKeys = [
    'value',
    'validity',
  ...
  const areEqual = compareProps<TypeTextFieldProps>(
    prevProps,
    nextProps,
    compareKeys
  );
